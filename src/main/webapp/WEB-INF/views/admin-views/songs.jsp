                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav" class="in">
                        ...
                        <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link" href="admin/thongtinUser.htm" aria-expanded="false"><i class="mdi me-2 mdi-account-settings-variant"></i><span class="hide-menu">Tài khoản</span></a>
                         ...
                         <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link" href="admin/thongminh.htm" aria-expanded="false"><i class="mdi me-2 mdi-help-circle"></i><span class="hide-menu">Thông minh</span></a>
                        </li>
            ...
            <div class="page-breadcrumb">
                <div class="row align-items-center">
                    <div class="col-md-6 col-8 align-self-center">
                        <h3 class="page-title mb-0 p-0">Danh sách nhạc</h3>
...
">
    ...
    <a type="button" href = "thembaihat.htm" class=" btn btn-primary" style="
    margin-right: 25px;
...
${message}
     <jsp:useBean id="pagedListHolder" scope="request" type="org.springframework.beans.support.PagedListHolder" />
						<c:url value="admin/trangchu.htm" var="pagedLink">
						<c:param name="u" value="~" />   
						</c:url>                             
                                <div class="table-responsive">
                                    <table class="table user-table">
                                        <thead>
                                            <tr>
                                                <th class="border-top-0">Id
<i class="ti-exchange-vertical"></i></th>
                                                <th class="border-top-0">Tên bài hát</th>
                                                <th class="border-top-0">Ngày phát hành<i class="ti-exchange-vertical" style="
    margin-left: 6px;
"></i></th>
 <th class="border-top-0">Thể loại<i class="ti-exchange-vertical" style="
    margin-left: 6px;
"></i></th>
                                                <th class="border-top-0">Số người nghe<i class="ti-exchange-vertical" style="
    margin-left: 6px;
"></i></th>
                                            <th class="border-top-0" style="
    text-align: center;
">Sửa/Xóa</th></tr>
                                        </thead>
                                        <tbody>                                           
<c:forEach var="u" items="${pagedListHolder.pageList}">					
    ...
    text-align: center;
">
    <a type="button" class="btn btn-secondary" href="admin/suasong/${u.id}.htm">Sửa</a>
<a type="button" class="btn btn-secondary" onclick="return confirm('Are you sure you want to delete this song?');" href="admin/xoasong/${u.id}.htm">Xóa</a></td></tr>
						</c:forEach>			                                                                                                                           
                                        </tbody>
                                    </table>
                                </div>
